    ...
    <section class="book_section layout_padding allhome">
        <div class="container">
            ...
            <div class="row" style="display: flex; justify-content: center; align-items: center;">
                <div class="col-md-6">
                    <div class="form_container">
                        ...
                        <div class="btn-box">
                            ...
                            <asp:Label ID="lblNewUser" CssClass="pl-3 text-black-100" style="color:white" Text="New User?  <a href='Registration.aspx' class='badge badge-info'>Register here...</a>" runat="server" />
                        </div>
               ...
               <%-- <div class="col-md-6">
                    <div class="form_container">
                        <asp:Image ImageUrl="~/User/Image/login.png" ID="Image1" CssClass="img-thumbnail" Style="width: 300px; height: 300px;" runat="server" />
                    </div>
                </div>--%>
