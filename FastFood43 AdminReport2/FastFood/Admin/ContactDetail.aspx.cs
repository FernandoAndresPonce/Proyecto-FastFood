        ...
        protected void btnConfirmDeletion_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (cbConfirmDeletion.Checked)
                {
                    ...
                    string script = @"<script type='text/javascript'>alert('Contact has been successfully DELETED !'); window.location.href='http://localhost:52000/Admin/Contact.aspx'</script>";
