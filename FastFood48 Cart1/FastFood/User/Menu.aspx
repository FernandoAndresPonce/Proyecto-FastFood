...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <style>
        ...
        .filters-content {
            width: 100%;
            flex-grow: 1; /* Permite que crezca con el contenido */
        }
    </style>
    ...
    <section class="food_section layout_padding-bottom pt-5 allhome">
        ...
        <div class="container">
            ...
            <div class="heading_container">
                <div class="align-self-center" style="text-align: center; width: 100%; margin-bottom: 30px">
    ...
    <script type="text/javascript">
        function checkScreenSize() {
            ...
            if (window.innerWidth <= 1000) {
                panel.style.display = 'block'; // Muestra el panel en pantallas pequeñas
            } else {
                panel.style.display = 'none'; // Oculta el panel en pantallas grandes
            }
        }
