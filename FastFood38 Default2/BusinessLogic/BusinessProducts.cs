    ...
    public class BusinessProducts
    {
            ...
            try
            {
                ...
                while (data.Read.Read())
                {
                    ...
                    if (!(data.Read["IsOffert"] is DBNull))
                        auxProduct.IsOffert = bool.Parse(data.Read["IsOffert"].ToString());
                    if (!(data.Read["Price"] is DBNull))
        ...
        public ProductD ShowProduct(ProductD selectedProduct)
        {
            try
            {
                ...
                while (data.Read.Read())
                {
                    ...
                    if (!(data.Read["IsOffert"] is DBNull))
                        selectedProduct.IsOffert = bool.Parse(data.Read["IsOffert"].ToString());
        ...
        public void UpdateWithSp(ProductD addProduct)
        {
            try
            {
                ...
                data.SetParameter("@IsOffert", addProduct.IsOffert);
                data.executeAction();
            }
            catch (Exception ex)
            {
