            ...
            <div class="page-wrapper" style="margin: 0px 10%">
                <div class="page-body">
                    <div class="col-12 mobil-inputs">
                        <h4 class="sub-title text-white" style="margin-bottom: 40px;">Categories</h4>
                    </div>
                    <asp:UpdatePanel runat="server">
                        <ContentTemplate>
                            <div class="d-grid justify-content-end" style="margin-bottom: 20px">
                                <asp:Button Text="Add Category" ID="btnAgregar" CssClass="btn btn-secondary" OnClick="btnAgregar_Click" runat="server" />
                            </div>
                            ...
                            <%} %>
                            <asp:GridView ID="dgvCategory" CssClass="table grid transparent-grid dataTable" runat="server" AutoGenerateColumns="False"
                                    ...
                                    <asp:TemplateField HeaderText="IsOffert↑↓" SortExpression="IsOffert">
                                        <ItemTemplate>
                                            <span class='<%# Convert.ToBoolean(Eval("IsOffert")) ? "badge badge-success" : "badge badge-danger" %>'>
                                                <%# Convert.ToBoolean(Eval("IsOffert")) ? "Offer" : "NoOffer" %>
                                            </span>
                                        </ItemTemplate>
                                        <HeaderStyle ForeColor="White" BackColor="Black" />
                                    </asp:TemplateField>
