            ...
            try
            {
                ...
                if (!IsPostBack)
                {
                    if (Segurity.activeSession(Session["User"]) && Request.QueryString["Id"] != null)
                    {
                        ...
                        //empezar por aca para finalizar 
//                        Select O.Quantity, P.ProductId, P.Quantity, (P.Quantity - O.Quantity) as QuantityReal from Orders O
//                         Inner Join Products P on O.ProductId = P.ProductId
//Where UserId = 97

                        List<OrdersD> listOrders = business.ListWithSPOrder(order);
                        //Session.Add("listOrder", business.ListWithSPOrder(order));
        ...
        private DataTable ConvertToDataTable(List<OrdersD> orders)
        {
            ...
            //DataTable con datos de la lista
