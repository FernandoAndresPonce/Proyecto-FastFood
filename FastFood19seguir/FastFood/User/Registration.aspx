        ...
        <div class="container">
            ...
            <div class="row p-5 justify-content-center">
                <div style="display: flex; justify-content: center; align-items: center;">
                    <asp:Image ID="imgUser" ImageUrl="~/User/Image/login.png" runat="server" CssClass="rounded mx-auto d-block" Style="width: 400px; height: 400px; background-size: contain; background-position: center" />
                </div>
            </div>
        </div>
    </section>
