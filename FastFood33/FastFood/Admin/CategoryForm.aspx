                            ...
                            <asp:UpdatePanel runat="server">
                                <ContentTemplate>
                                    ...
                                    <div style="margin: 0px 25% 25px; text-align: center; font-size: 1.1em">
                                        ...
                                        <div style="margin: 10px 25% 0px; text-align: center; font-size: 1.1em">
                                            <asp:CheckBox ID="cbOffert" runat="server" Checked="false" OnCheckedChanged="cbOffert_CheckedChanged" AutoPostBack="true" />
                                        </div>
                                        <div style="margin: 0px 25% 25px; text-align: center; font-size: 1.1em">
                                            <%if (cbOffert.Checked)
                                                { %>
                                            <asp:Label Text="Offert" ID="Label1" CssClass="badge badge-success" runat="server" />
                                            ...
                                            <%}
                                                ...
                                                { %>
                                            <asp:Label Text="No Offert" ID="Label2" CssClass="badge badge-danger" runat="server" />
                                            <%} %>
                                        </div>
                                        <%-------------------------------%>
                                        <%}
