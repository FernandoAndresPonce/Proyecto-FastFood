...
<%--                        <asp:Label ID="lblAlreadyUser" CssClass="pl-3 text-black-100" Text="Already registered? <a href='Login.aspx' class='badge badge-info'>Login here...</a>" runat="server" />--%>
            ...
            <div class="row p-5 justify-content-center">
                <div style="display: flex; justify-content: center; align-items: center;">
                    <asp:Image ImageUrl="~/User/Image/PerfilImage.jpg" ID="imgUser" runat="server" CssClass="rounded mx-auto d-block" Style="width: 400px; background-size: contain; background-position: center" />
                </div>
            </div>
        </div>
    </section>
