...
namespace FastFood.User
{
    public partial class Cart : System.Web.UI.Page
    {
        ...
        protected void rCartItem_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            try
            {
                ...
                if (e.CommandName == "updateCart")
                {
                    ...
                    //OJO VER POR LAS DUDAS, sus comportamientos.
                    ...
                    for (int item = 0; item < rCartItem.Items.Count; item++)
                    {
                        if (rCartItem.Items[item].ItemType == ListItemType.Item || rCartItem.Items[item].ItemType == ListItemType.AlternatingItem)
                        {
                            ...
                            if (isTrue)
                            {
                                // actualiza carrito en la base de datos.
                                //ver aca
                                //isCartUpdate = Utils.updateCartQuantity(updateQuantity, productId, Convert.ToInt32(Session["user"]);
                                BusinessCarts business = new BusinessCarts();
                    ...
                    // checkear la cantdad de producto que tiene.
        ...
        protected void lbContinueShopping_Click1(object sender, EventArgs e)
        {
            lblMsg.Visible = false;
