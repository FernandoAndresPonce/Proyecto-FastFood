                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            ...
                            <div class="mb-3" style="margin: 10px 25% 0px">
                                ...
                                <asp:RangeValidator ErrorMessage="(Allowed range 0-300)" ControlToValidate="txtDescription" Type="String" MinimumValue="0" MaximumValue="300" runat="server" CssClass="validacion" Display="Dynamic" SetFocusOnError="true"></asp:RangeValidator>
                                <asp:TextBox ID="txtDescription" TextMode="MultiLine" runat="server" CssClass="form-control" MaxLength="300"></asp:TextBox>
                            </div>
