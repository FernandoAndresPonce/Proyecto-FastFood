...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <style>
        ...
        .grid-wrapper {
            width: 100%;
            overflow: auto; /* Permite desplazamiento si el contenido es demasiado ancho */
        }
    </style>
                        ...
                        <ContentTemplate>
                            <div class="centered-container">
                                <asp:TextBox ID="txtFastFilter" placeholder="Category quick search..."
                                    CssClass="form-control" Style="background: rgba(256, 256, 256, 0.5); color: black;" runat="server"
