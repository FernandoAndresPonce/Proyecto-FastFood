                                                ...
                                                <asp:Repeater ID="rOrderStatus" runat="server" OnItemCommand="rOrderStatus_ItemCommand">
                                                    ...
                                                    <ItemTemplate>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:Label ID="lblStatus" runat="server" Text='<%# Eval("Status") %>' CssClass='<%# Eval("Status").ToString() == "Deilvered" ? "badge badge-success" : "badge badge-warning" %>'></asp:Label>
                                                            </td>
                                                            <td>
                                                                <%# Eval("ProductName") %>
                                                            </td>
                                            ...
                                            <div>
                                                ...
                                                <%--<div class="form-group">
                                                    ...
                                                    <div class="form-check pl-4">
                                                        <asp:CheckBox Text="&nbsp; IsActive" ID="cbIsActive" CssClass="form-check-input" runat="server" />
                                                    </div>--%>
