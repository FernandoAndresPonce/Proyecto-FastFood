                    ...
                    <asp:UpdatePanel runat="server">
                        <ContentTemplate>
                            ...
                            <div style="text-align: center; color: white">
                                <asp:TextBox ID="txtFastFilter" placeholder="Product quick search..." OnTextChanged="txtFastFilter_TextChanged" AutoPostBack="true"
                            ...
                            <asp:GridView ID="dgvProducts" CssClass="table grid transparent-grid" runat="server" AutoGenerateColumns="False"
