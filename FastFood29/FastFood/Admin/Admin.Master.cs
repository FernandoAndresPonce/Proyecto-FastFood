...
namespace FastFood.Admin
{
    public partial class Admin : System.Web.UI.MasterPage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Page is Dashboard || Page is Category || Page is CategoryForm || Page is Error || Page is Products || Page is ProductDetail || Page is ProductForm || Page is Users || Page is UserDetail || Page is OrderStatus || Page is CategoryDetail )
            {
